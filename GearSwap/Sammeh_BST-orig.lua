...
function job_setup()
	...
	if player.sub_job == 'NIN' or player.sub_job == 'DNC' then
		...
		send_command('@wait 1;input /equip sub "Beatific Shield +1"')
	end
...
function user_setup()
    ...
    state.JugMode = M{['description']='Jug Mode', 'BlackbeardRandy', 'SwoopingZhivago', 'WarlikePatrick',
        'HeadbreakerKen', 'VivaciousVickie', 'BouncingBertha', 'ThreestarLynn', 'HeraldHenry', 'AlluringHoney'}
...
function init_gear_sets()
	...
	Ready_MAB_legs = { name="Valor. Hose", augments={'Pet: "Mag.Atk.Bns."+30','"Store TP"+5','System: 1 ID: 1795 Val: 4','Pet: Accuracy+6 Pet: Rng. Acc.+6','Pet: Attack+14 Pet: Rng.Atk.+14',}}
    Ready_MAB_feet = { name="Valorous Greaves", augments={'Pet: "Mag.Atk.Bns."+30','Pet: "Subtle Blow"+6','Pet: VIT+4','Pet: Accuracy+1 Pet: Rng. Acc.+1',}}
    ...
    sets.midcast.Pet.MagicAtkReadyDWNE = set_combine(sets.midcast.Pet.MagicAtkReadyNE, {main=Ready_MAB_Axe,sub={ name="Kumbhakarna", augments={'Pet: "Mag.Atk.Bns."+20','Pet: Phys. dmg. taken -4%','Pet: TP Bonus+160',}}})
    sets.midcast.Pet.MagicAtkReadyDWNE.MedAcc = set_combine(sets.midcast.Pet.MagicAtkReadyNE.MedAcc, {main=Ready_MAB_Axe,sub={ name="Kumbhakarna", augments={'Pet: "Mag.Atk.Bns."+20','Pet: Phys. dmg. taken -4%','Pet: TP Bonus+160',}}})
    sets.midcast.Pet.MagicAtkReadyDWNE.HighAcc = set_combine(sets.midcast.Pet.MagicAtkReadyNE.HighAcc, {main=Ready_MAB_Axe,sub={ name="Kumbhakarna", augments={'Pet: "Mag.Atk.Bns."+20','Pet: Phys. dmg. taken -4%','Pet: TP Bonus+160',}}})
