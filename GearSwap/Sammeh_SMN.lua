...
function init_gear_sets()
    ...
    -- Normal melee group
    sets.engaged = {main="Nirvana", ammo="Sancus Sachet",
        head={ name="Merlinic Hood", augments={'Mag. Acc.+23 "Mag.Atk.Bns."+23','Magic Damage +13','"Mag.Atk.Bns."+9',}},
		neck="Combatant's torque",ear1="Cessance earring",ear2="Digni. Earring",
        body="Shomonjijoe +1",hands="Artsieq cuffs",ring1="Petrov Ring",ring2="Hetairoi ring",
        back="Campestres's cape",waist="Windbuffet Belt",legs="Enticer's pants",feet="Beckoner's pigaches +1"}
end
