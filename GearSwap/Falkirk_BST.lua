-------------------------------------------------------------------------------------------------------------------
-- Last Revised: September 1st, 2016
-- 
...
function init_gear_sets()
    ...
    Reward_back = {name="Artio's Mantle", augments={'MND+20','Mag. Acc+20 /Mag. Dmg.+20','MND+10','"Fast Cast"+10',}}
    ...
    Pet_Melee_feet = "Emicho Gambieras +1"
    ...
    FC_legs = MAB_legs
    FC_feet = MAB_feet
    FC_back = {name="Artio's Mantle", augments={'MND+20','Mag. Acc+20 /Mag. Dmg.+20','MND+10','"Fast Cast"+10',}}
    ...
    MAcc_legs = MAB_legs
    MAcc_feet = MAB_feet
    MAcc_back = {name="Artio's Mantle", augments={'MND+20','Mag. Acc+20 /Mag. Dmg.+20','MND+10','"Fast Cast"+10',}}
    ...
    if state.PetMode.value == 'PetOnly' then
        if pet.status == "Engaged" then
            if player.sub_job == 'NIN' or player.sub_job == 'DNC' then
                ...
                elseif state.DefenseMode.value == "Physical" and state.MagicalDefenseMode.value == "PDT" then
